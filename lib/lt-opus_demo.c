...
/* ./.libs/lt-opus_demo.c - temporary wrapper executable for .libs/opus_demo
   Generated by libtool (GNU libtool) 2.4.6

   The opus_demo program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "opus_demo"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# opus_demo - temporary wrapper script for .libs/opus_demo\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The opus_demo program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"opus_demo:opus_demo:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"opus_demo:opus_demo:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"opus_demo:opus_demo:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
