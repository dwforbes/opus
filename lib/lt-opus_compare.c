...
/* ./.libs/lt-opus_compare.c - temporary wrapper executable for .libs/opus_compare
   Generated by libtool (GNU libtool) 2.4.6

   The opus_compare program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "opus_compare"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# opus_compare - temporary wrapper script for .libs/opus_compare\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The opus_compare program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"opus_compare:opus_compare:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"opus_compare:opus_compare:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"opus_compare:opus_compare:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
