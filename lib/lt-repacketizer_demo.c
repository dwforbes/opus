...
/* ./.libs/lt-repacketizer_demo.c - temporary wrapper executable for .libs/repacketizer_demo
   Generated by libtool (GNU libtool) 2.4.6

   The repacketizer_demo program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Users/denni/Downloads/opus-1.3.1/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Users/denni/Downloads/opus-1.3.1/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "repacketizer_demo"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# repacketizer_demo - temporary wrapper script for .libs/repacketizer_demo\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The repacketizer_demo program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("  notinst_deplibs=' libopus.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"repacketizer_demo:repacketizer_demo:$LINENO: libtool wrapper (GNU lib", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"repacketizer_demo:repacketizer_demo:$LINENO: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"repacketizer_demo:repacketizer_demo:$LINENO: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='repacketizer_demo'\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Users/denni/Downloads/opus-1.3.1/.libs:/usr/local/lib:/usr", f);
  fputs ("/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Users/denni/Downloads/opus-1.3.1/.libs:$PATH\"\n", f);
  fputs ("\n", f);
